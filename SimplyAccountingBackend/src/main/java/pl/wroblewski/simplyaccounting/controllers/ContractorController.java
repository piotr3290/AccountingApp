...
public class ContractorController {
    ...
    @GetMapping(path = "/{id}")
    public ResponseEntity<ContractorDto> getContractor(@PathVariable int id) {
        return ResponseEntity.ok(contractorService.getContractor(id));
    }

    @PostMapping
    public ResponseEntity<ContractorDto> createContractor(@RequestBody @Validated(CreateInfo.class) ContractorDto contractor) {
        return ResponseEntity.ok(contractorService.createContractor(contractor));
    }

    @PutMapping
    public ResponseEntity<ContractorDto> updateContractor(@RequestBody @Validated(EditInfo.class) ContractorDto contractor) {
