    ...
    <v-card class="mb-8">
      <v-row class="mx-0 mt-0">
        ...
        <v-col md lg xl class="col-12 col-sm-6">
          ...
          <div class="text-h4">{{ $_.capitalize($t('advance.advances')) }}</div>
        ...
        <v-col md lg xl class="col-12 col-sm-6">
          ...
          <div class="text-h4">{{ $_.capitalize($t('landlord.landlord')) }}</div>
        ...
        <v-col md lg xl class="col-12 col-sm-6">
          ...
          <div class="text-h4">{{ $_.capitalize($t('cooperative.cooperative')) }}</div>
        ...
        <v-col md lg xl class="col-12 col-sm-6">
          ...
          <div class="text-h4">{{ $_.capitalize($t('contractor.contractor')) }}</div>
        ...
        <v-col md lg xl class="col-12 col-sm-12">
          ...
          <div class="text-h4">{{ $_.capitalize($t('invoice.invoice')) }}</div>
